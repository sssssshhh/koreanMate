      ...
      <div className="w-full h-full bg-white rounded-lg border-l border-r border-t pt-8 pb-8 border-amber-200 flex flex-col justify-center items-center overflow-hidden relative">
        ...
        <div className="flex flex-col justify-start items-center">
          <img 
            ...
            className="pb-4"
          />
          <div className="text-stone-950 text-4xl font-pretendardormal pb-2 text-center">{title}</div>
          <div className="text-neutral-400 text-base font-pretendardormal font-['Lato'] text-center">
            {renderSubtitle()}
          </div>
        </div>
