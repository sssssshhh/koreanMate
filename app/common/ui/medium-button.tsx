...
const mediumButtonVariants = cva(
...
function MediumButton({
  ...
  VariantProps<typeof mediumButtonVariants> & {
    asChild?: boolean
    bgColor?: string
    textColor?: string
  }) {
  ...
  return (
    <Comp
      data-slot="medium-button"
      className={cn(
        mediumButtonVariants({ variant, size, className }),
...
export { MediumButton, mediumButtonVariants }
